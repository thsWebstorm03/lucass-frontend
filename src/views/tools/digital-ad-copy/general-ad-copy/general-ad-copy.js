...
const GeneralAdCopyForm = (props) => {
   ...
   const generateGeneral = async () => {
      ...
      const response = await axios.post(BASE_URL + '/api/digital/general', {
         "name": name,
         "des": des,
         "tone": tone,
         "lang": lang
      ...
      props.handleGeneral(response.data.completion_text);
   }

   return (
      <Card>
         <CardHeader title='General Ad copy' />
...
export default GeneralAdCopyForm
