      ...
      <React.Fragment>
         ...
         <section id='slider' >
            <Carousel cols={1} rows={1} gap={0} loop autoplay={2000} >
               <Carousel.Item>
                  <img width={'100%'} height={'900px'} src={`${PUBLIC_URL}` + 'images/new_slider1.jpg'} />
                  <div className='text-center ' style={{ position: 'absolute', height: '100%', width: '100%', left: 0, top: 0, backgroundColor: 'rgba(0,0,0,0.5)' }}>
                     <Grid cols={1} style={{zIndex : "5"}}>
                        <Grid item span={24}>
                           <p className='text-pop-up-top h1 dark-mode' style={{ fontSize: '80px', marginTop: '200px' }}>Write Better, Write Faster <br></br>Code With Genie</p>
                        </Grid>
                        <Grid item span={24}>
               ...
               <Carousel.Item>
                  <img width={'100%'} height={'900px'} src={`${PUBLIC_URL}` + 'images/new_slider2.jpg'} />
                  <div className='text-center' style={{ marginTop: "-800px" }} >
                     <p className='h1 dark-mode' style={{ fontSize: '100px', marginTop: '100px' }}></p>
                  </div>
               </Carousel.Item>
               <Carousel.Item>
                  <img width={'100%'} height={'900px'} src={`${PUBLIC_URL}` + 'images/new_slider3.jpg'} />
                  <div className='text-center' style={{ marginTop: "-800px" }} >
                     <p className='text-pop-up-top h1 dark-mode' style={{ fontSize: '100px', marginTop: '150px' }}>Artificial Intelligence</p>
                     <p className='animated fadeIn infinite dtime-2 h1 dark-mode' style={{ fontSize: '30px'}}>Artificial Intelligence</p>
                  </div>
               </Carousel.Item>
            </Carousel>
            <div style={{width : "100%", height:"calc(100vh - 380px)", overflow : "hidden", position:"absolute",left:"0", top:"80px", zIndex:"3", backgroundColor:"rgba(0,0,0,0.2)"}}>
               <Particles
                     id="tsparticles"
                     init={particlesInit}
         ...
         <section id='landings' className='container pt-5 mt-2 mt-md-4 mt-lg-3 text-center'>
            <h2 className='text-pop-up-top h1 mt-5 pt-2 pt-lg-0 text-light'>What we do?</h2>
